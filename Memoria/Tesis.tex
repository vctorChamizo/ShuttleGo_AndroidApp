...
%
\ifpdf\hypersetup{%
    pdftitle = {Trabajo de Fin de Grado - ShuttleGo},
    pdfsubject = {Trabajo de Fin de Grado},
    pdfkeywords = {TFG, ShuttleGo, Shuttle bus, trabajo de fin de grado},
...
\include{Capitulos/motivacion}
\include{Capitulos/estadoArte}
\include{Capitulos/arquitectura}
\include{Capitulos/tecnologia}
\include{Capitulos/casosUso}
%\include{...}
